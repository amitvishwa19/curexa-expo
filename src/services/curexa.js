...
// Fallback Mock Data Providers (Indian Healthcare Context)
export const MOCK_DATA = {
  patients: [
    {
      ...
      condition: 'Post-PTCA Angioplasty Observation',
    ...
    },
    {
      ...
      bed: 'Bay 4',
      primaryDoctor: 'Dr. Amit Malhotra',
      condition: 'Acute Migraine & Cervical Spondylosis',
    ...
    },
    {
      ...
      condition: 'Routine Prenatal Trimester 2 Checkup',
      ...
      insurance: {
        ...
        policyNumber: 'PMJAY-IND-8831092',
        coverage: '100%',
      },
    },
    {
      ...
      bed: 'ICU-Bed 02',
      primaryDoctor: 'Dr. Vikram Sen',
      condition: 'Post Anterior Wall STEMI',
      ...
      insurance: {
        provider: 'CGHS / Star Health Top-Up',
        policyNumber: 'CGHS-DEL-1102938',
        coverage: '85%',
      },
    },
  ],
  ...
  appointments: [
    {
      ...
      priority: 'High',
      status: 'IN_PROGRESS',
      symptoms: 'Post-catheterization review & 2D Echo check',
    },
    {
      id: 'apt-2',
      token: 'A-02',
    ...
    },
    {
      ...
      token: 'A-04',
      patientId: 'p-5',
      patientName: 'Suresh Kumar Gupta',
      ...
      priority: 'Normal',
      status: 'COMPLETED',
      symptoms: 'Knee arthroscopy suture removal & physio check',
    },
  ],
  ...
  wards: [
    {
      ...
      totalBeds: 12,
      occupiedBeds: 9,
      nurseInCharge: 'Sister Sunita Rao, B.Sc Nursing',
      rooms: [
        {
          id: 'r-101',
          name: 'Room 301 (Semi-Private)',
          beds: [
            { id: 'b-101a', number: 'Bed 301-A', status: 'OCCUPIED', patientName: 'Rohan Mehra', doctor: 'Dr. Rajesh Sharma', admittedAt: 'Sep 13' },
        ...
        },
        {
          ...
          beds: [
            { id: 'b-102a', number: 'Bed 302', status: 'OCCUPIED', patientName: 'Deepika Joshi', doctor: 'Dr. Rajesh Sharma', admittedAt: 'Sep 12' },
          ],
        },
        {
          id: 'r-103',
          name: 'Room 303 (ICU Step-down)',
          beds: [
    ...
    },
    {
      ...
      totalBeds: 8,
      occupiedBeds: 7,
      nurseInCharge: 'Sister Angela Francis, CCRN',
      rooms: [
        {
          id: 'r-201',
          name: 'Critical Bay A',
          beds: [
            { id: 'b-201a', number: 'ICU-Bed 01', status: 'OCCUPIED', patientName: 'Pooja Aggarwal', doctor: 'Dr. Vikram Sen', admittedAt: 'Sep 11' },
            { id: 'b-201b', number: 'ICU-Bed 02', status: 'OCCUPIED', patientName: 'Rameshwar Prasad', doctor: 'Dr. Vikram Sen', admittedAt: 'Sep 10' },
          ],
        },
        {
          id: 'r-202',
          ...
          beds: [
            ...
            { id: 'b-202b', number: 'ICU-Bed 04', status: 'OCCUPIED', patientName: 'Meera Iyer', doctor: 'Dr. Vikram Sen', admittedAt: 'Sep 14' },
          ],
        },
      ],
    },
    {
      ...
      totalBeds: 20,
      occupiedBeds: 14,
      nurseInCharge: 'Sister Mary Joseph, RN',
      rooms: [
        {
          id: 'r-301',
          name: 'General Male 201',
          beds: [
            { id: 'b-301a', number: 'Bed G-01', status: 'OCCUPIED', patientName: 'Amitava Sen', doctor: 'Dr. Amit Malhotra', admittedAt: 'Sep 13' },
            { id: 'b-301b', number: 'Bed G-02', status: 'AVAILABLE', patientName: null, doctor: null, admittedAt: null },
            { id: 'b-301c', number: 'Bed G-03', status: 'OCCUPIED', patientName: 'Harish Chander', doctor: 'Dr. Sneha Kulkarni', admittedAt: 'Sep 14' },
          ],
        },
      ],
    },
  ...
  medicines: [
    {
      id: 'med-1',
      name: 'Atorvastatin Calcium 20mg (Storvas-20)',
    ...
    {
      id: 'med-3',
      name: 'Metformin HCl 500mg ER (Glycomet-SR)',
      generic: 'Metformin',
    ...
    {
      id: 'med-4',
      name: 'Pantoprazole IV 40mg (Pan-40 IV)',
    ...
    {
      id: 'med-5',
      name: 'Paracetamol 650mg Fast-Release (Dolo 650)',
      generic: 'Paracetamol',
  ...
  invoices: [
    {
      ...
      balance: 0.0,
      status: 'PAID',
      paymentMethod: 'Star Health TPA (80%) + UPI',
      items: [
        { name: 'Cardiology Consultation (Super Specialty)', qty: 1, rate: 1500.0, total: 1500.0 },
        { name: 'Private Deluxe Room (3 Days)', qty: 3, rate: 8500.0, total: 25500.0 },
        { name: '2D Echocardiography & ECG', qty: 1, rate: 4500.0, total: 4500.0 },
        { name: 'IPD Pharmacy & Consumables', qty: 1, rate: 14000.0, total: 14000.0 },
      ],
    },
    {
      id: 'inv-2',
      ...
      items: [
        { name: 'Neurology OPD Consultation', qty: 1, rate: 1200.0, total: 1200.0 },
        { name: 'Brain CT Scan', qty: 1, rate: 7300.0, total: 7300.0 },
      ],
    },
    {
      id: 'inv-3',
      invoiceNumber: 'INV-2026-4403',
      patientName: 'Harish Chander',
      ...
      items: [
        { name: 'Orthopedic Consultation', qty: 1, rate: 1200.0, total: 1200.0 },
        { name: 'Digital Knee X-Ray (Bilateral)', qty: 1, rate: 3000.0, total: 3000.0 },
      ],
    },
  ],
  ...
  departments: [
    {
      ...
      headOfDepartment: 'Dr. Rajesh Sharma, MD, DM',
      doctorsCount: 6,
      bedCount: 16,
      activePatients: 14,
    ...
    },
    {
      ...
      color: '#8b5cf6',
      icon: 'pulse-outline',
      headOfDepartment: 'Dr. Amit Malhotra, MD, DM',
      doctorsCount: 4,
      bedCount: 10,
      activePatients: 8,
    ...
    },
    {
      ...
      color: '#ec4899',
      icon: 'woman-outline',
      headOfDepartment: 'Dr. Priya Nair, MD, DGO',
      doctorsCount: 5,
      bedCount: 14,
      activePatients: 11,
      specialties: ['Maternal-Fetal Medicine', 'Laparoscopy', 'High-Risk Pregnancy'],
    },
    {
      id: 'dept-4',
      ...
      color: '#f59e0b',
      icon: 'body-outline',
      headOfDepartment: 'Dr. Sneha Kulkarni, MS (Ortho)',
      doctorsCount: 5,
      bedCount: 18,
      activePatients: 15,
      specialties: ['Robotic Joint Replacement', 'Arthroscopy', 'Spine Surgery'],
    },
    {
      id: 'dept-5',
      ...
      color: '#06b6d4',
      icon: 'flash-outline',
      headOfDepartment: 'Dr. Vikram Sen, MD (Critical Care)',
      doctorsCount: 8,
      bedCount: 20,
      activePatients: 18,
      specialties: ['Triage', 'Trauma Resuscitation', 'Intensive Care Unit (ICU)'],
    },
  ],
    ...
    setTimeout(() => {
      resolve({
        ...
        summaryText: `PATIENT DISCHARGE SUMMARY\n` +
          ...
          `Attending Doctor: ${patient.primaryDoctor || 'Dr. Rajesh Sharma, MD'}\n\n` +
          ...
          `1. Atorvastatin 20mg (Storvas-20) - 1 Tab OD at night x 30 days\n` +
          `2. Pantoprazole 40mg (Pan-40) - 1 Tab OD empty stomach x 14 days\n` +
          `3. Paracetamol 650mg (Dolo 650) - 1 Tab SOS for pain\n\n` +
...
export const MOCK_HANDOVERS = [
  {
    ...
    ward: 'ICU & Emergency',
    fromDoctor: 'Dr. Rajesh Sharma, MD',
    toDoctor: 'Dr. Amit Malhotra, MD',
    timestamp: 'Today, 03:30 PM',
    sbar: {
      situation: '8 IPD patients in ICU, 2 critical on ventilator weaning protocol.',
      background: 'Rameshwar Prasad post-MI day 2 stable; Kishore Das hypotensive on inotrope support.',
      assessment: 'Kishore Das requiring close arterial line BP monitoring; may need inotrope titration.',
  ...
  },
  {
    ...
    ward: 'Cardiology Ward 3B',
    fromDoctor: 'Dr. Vikram Sen',
    toDoctor: 'Dr. Rajesh Sharma',
    timestamp: 'Today, 07:45 AM',
    sbar: {
      situation: 'All 9 patients stable overnight; 2 planned discharges today.',
      background: 'Deepika Joshi ready for discharge pending final 2D echo review.',
      assessment: '2D Echo scheduled at 10:00 AM. Invoices cleared with Star Health TPA.',
...
export const MOCK_ON_CALL_DOCTORS = [
  { id: 'doc-1', name: 'Dr. Rajesh Sharma, MD', specialty: 'Cardiology', onCall: true, phone: '+91 98765 01920', status: 'In Hospital (Cabin 3B)', badge: 'PRIMARY ON-CALL' },
  { id: 'doc-2', name: 'Dr. Amit Malhotra, MD', specialty: 'Neurology', onCall: true, phone: '+91 98112 01880', status: 'On Active Duty', badge: 'ER SPECIALIST' },
  { id: 'doc-3', name: 'Dr. Vikram Sen, MD', specialty: 'Critical Care / ICU', onCall: true, phone: '+91 88001 01740', status: 'ICU Bay A', badge: 'INTENSIVIST' },
  { id: 'doc-4', name: 'Dr. Priya Nair, MD', specialty: 'Obstetrics & Gyn', onCall: false, phone: '+91 91234 01630', status: 'On-Call (15 min ETA)', badge: 'BACKUP CALL' },
  { id: 'doc-5', name: 'Dr. Sneha Kulkarni, MS', specialty: 'Orthopedics & Trauma', onCall: true, phone: '+91 99887 01520', status: 'OT 2 (Surgery)', badge: 'SURGEON ON-CALL' },
];
...
export const MOCK_WHATSAPP_LOGS = [
  {
    ...
    phone: '+91 98765 43210',
    type: 'TOKEN_UPDATE',
    message: 'Namaste Deepika, your OPD token A-01 with Dr. Rajesh Sharma is next in 10 mins. Please report to Cabin 3B.',
    status: 'DELIVERED',
    sentAt: '10:15 AM',
  },
  {
    ...
    phone: '+91 88001 23456',
    type: 'LAB_REPORT',
    message: 'Your Thyroid & Glucose Lab Report (LAB-2026-903) is ready. Tap to download PDF: https://curexa.devlomatix.com/r/903',
    status: 'READ',
    sentAt: '09:40 AM',
  },
  {
    ...
    phone: '+91 91234 56789',
    type: 'FAMILY_UPDATE',
    message: 'Family update from Curexa ICU: Rameshwar Prasad vitals stable. Doctor rounds completed. Visiting hours 4-6 PM.',
    status: 'DELIVERED',
    sentAt: '08:30 AM',
  },
];
